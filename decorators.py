# 1. Simple Decorator without syntactic sugar
"""
...
def write_file(file_path):
    with open(file_path, mode='w') as file:
        file.write("Hello, this was written from a decorated function")
...
class Write_Read_File:
    # not sure whether to decorate the __enter__ or __exit__ object
...
## the class above should ideally do the same thing as the function below
